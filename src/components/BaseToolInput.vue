    ...
    <div class="ant-col-r">
      <div class="ant-form-item-control">
        <div :class="['ant-input-'+icon]">
          <div class="ant-input-number ant-input-number-sm" :class="{'input-com-number':fullInput,'slider-input':!fullInput}">
            <div class="ant-input-number-handler-wrap" v-if="count">
              <a class="ant-input-number-handler ant-input-number-handler-up " :class="{'ant-input-number-handler-down-disabled':maxDisabled}" @keydown.enter="increase" @click="increase">
                <span class="ant-input-number-handler-up-inner"></span>
              </a>
              <a class="ant-input-number-handler ant-input-number-handler-down " :class="{'ant-input-number-handler-down-disabled':minDisabled}" @keydown.enter="decrease" @click="decrease">
