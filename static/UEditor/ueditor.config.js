...
(function () {
  ...
  window.UEDITOR_HOME_URL = 'https://server.jianxiakeji.com'
  /**
  ...
  window.UEDITOR_CONFIG = {
    ...
    zIndex: 20000 //编辑器层级的基数,默认是900
      ...
      ,
    initialStyle: '' //编辑器层级的基数,可以用来改变字体等
    ...
    minFrameWidth: 800 //编辑器拖动时最小宽度,默认800
      ...
      ,
    toolbars: [
      ["undo", "redo", "|", "fontsize", "blockquote", "|", "removeformat", "formatmatch", "|", "link", "emotion", "spechars", "superscript", "subscript", "|", "PastePlain", "directionalityltr", "directionalityrtl", 'touppercase', 'tolowercase', "bold", "italic", "underline", "forecolor", "shadowcolor", "backcolor", "|", "indent", "lineheight", 'letterspacing', 'outpadding', "rowspacingtop", "rowspacingbottom", "|", "justifyleft", "justifycenter", "justifyright", "justifyjustify", "insertorderedlist", "insertunorderedlist", "|", "autotypeset", "insertvideo", 'background', 'insertimage', "horizontal", "searchreplace", "|", "source", "cleardoc"]
    ],
